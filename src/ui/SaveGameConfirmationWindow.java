...
public class SaveGameConfirmationWindow extends JPanel{
	
	public SaveGameConfirmationWindow(GameFrame frameRef, String saveName) {
		...
		JLabel text = new JLabel("<html>There's a save with that name.<br>Are you sure you want to overwrite it?</html>");
		...
		noBtn.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				frameRef.removeSaveGameConfirmationWindow();
			}
		});
